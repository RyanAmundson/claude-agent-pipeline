...
function buildGraph() {
  svg = document.getElementById('feature-pipeline-graph');
  statusEl = document.getElementById('feature-pipeline-status');
  drillEl = document.getElementById('feature-pipeline-epics');
  if (!svg) return false;
